...
async function seedDevFixtures(serviceId: string, growthPlanId: string): Promise<void> {
  ...
  await db
    .insert(contractors)
    .values({ id: ID.contractor, companyName: 'Lone Star Roofing Co.', slug: 'lone-star-roofing-co', referralCode: 'LONESTAR', bio: 'Family-owned roofing contractor serving the Dallas metro since 2009. Licensed, insured, and known for clean tear-offs and on-time crews.', logoUrl: C1_LOGO, licenseNumber: 'TX-ROOF-44821', yearsInBusiness: 16, verificationStatus: 'verified', creditBalance: 328, profileScore: 100, avgRating: '4.50', totalReviews: 2 })
    .onConflictDoUpdate({ target: contractors.id, set: { companyName: 'Lone Star Roofing Co.', slug: 'lone-star-roofing-co', referralCode: 'LONESTAR', bio: 'Family-owned roofing contractor serving the Dallas metro since 2009. Licensed, insured, and known for clean tear-offs and on-time crews.', logoUrl: C1_LOGO, verificationStatus: 'verified', creditBalance: 328, profileScore: 100, avgRating: '4.50', totalReviews: 2 } })
