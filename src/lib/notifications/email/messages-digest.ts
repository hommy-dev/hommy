...
const APP_URL = process.env.NEXT_PUBLIC_APP_URL ?? 'https://rooflink.com'
...
export function renderMessagesDigestEmail(args: {
  ...
  const subject =
    totalUnread === 1
      ? 'You have 1 new message on RoofLink'
      : `You have ${totalUnread} new messages on RoofLink`
                ...
                <tr>
                  <td style="padding:24px 28px 28px;">
                    <p style="margin:0;font-size:11px;line-height:1.5;color:#9ca3af;">
                      You're receiving this digest because you have unread messages on RoofLink.
