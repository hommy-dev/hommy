...
const APP_URL = process.env.NEXT_PUBLIC_APP_URL ?? 'https://paintpro.com'
...
export function renderMessagesDigestEmail(args: {
  ...
  const subject =
    totalUnread === 1
      ? 'You have 1 new message on PaintPro'
      : `You have ${totalUnread} new messages on PaintPro`
                ...
                <tr>
                  <td style="padding:24px 28px 28px;">
                    <p style="margin:0;font-size:11px;line-height:1.5;color:#9ca3af;">
                      You're receiving this digest because you have unread messages on PaintPro.
