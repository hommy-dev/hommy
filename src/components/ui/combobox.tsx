...
function ComboboxTrigger({
  ...
  return (
    ...
    >
      {children}
      <Icon name="down" className="pointer-events-none size-4 lg:size-[1.111vw] text-muted-foreground" />
    </ComboboxPrimitive.Trigger>
  )
}
...
function ComboboxClear({ className, ...props }: ComboboxPrimitive.Clear.Props) {
  return (
    <ComboboxPrimitive.Clear
      ...
      {...props}
    >
      <Icon name="close" className="pointer-events-none size-4 lg:size-[1.111vw]" />
    </ComboboxPrimitive.Clear>
  )
}
...
function ComboboxList({ className, ...props }: ComboboxPrimitive.List.Props) {
  return (
    <ComboboxPrimitive.List
      ...
      className={cn(
        "no-scrollbar max-h-[min(calc(--spacing(72)---spacing(9)),calc(var(--available-height)---spacing(9)))] scroll-py-1 overflow-y-auto overscroll-contain p-1 lg:p-[0.278vw] data-empty:p-0",
        className
      )}
      {...props}
    />
...
function ComboboxItem({
  ...
  return (
    ...
    >
      ...
      >
        <Icon name="tick" className="pointer-events-none size-4 lg:size-[1.111vw]" />
      </ComboboxPrimitive.ItemIndicator> */}
    </ComboboxPrimitive.Item>
  )
}
