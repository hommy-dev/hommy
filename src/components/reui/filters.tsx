...
// ReUI vendored filter component. Upstream uses several controlled-from-prop
// + sync-via-effect patterns that trip Next 16's stricter react-hooks rules.
// The patterns are intentional in the upstream library; rewriting them is
// out of scope. Disable file-wide so we don't paper over similar patterns
...
import { AlertCircleIcon, Cancel01Icon, Tick02Icon, Plug01Icon as Plus01Icon } from "@hugeicons/core-free-icons"
