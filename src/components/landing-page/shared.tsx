...
export function Eyebrow({
  ...
  return (
    <span
      className={cn(
        "inline-flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.16em] text-foreground/45",
        className,
      )}
    >
...
export function AssetPlaceholder({
  ...
  return (
    <div
      className={cn(
        "relative flex items-center justify-center overflow-hidden rounded-md border border-dashed bg-muted/70",
        className,
      )}
    >
      <div className="flex flex-col items-center gap-2 px-4 text-center text-foreground/35">
...
export function Stars({ className }: { className?: string }) {
  return (
    <span className={cn("inline-flex gap-0.5 text-amber-400", className)} aria-hidden="true">
