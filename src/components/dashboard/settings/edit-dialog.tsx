...
export function EditDialog({
  ...
  return (
    ...
    >
      ...
      <DialogContent
        className={wide ? "scrollbar-thin sm:max-w-lg lg:max-w-[42vw] max-h-[95vh] overflow-y-auto" : "scrollbar-thin sm:max-w-md lg:max-w-[34vw]  max-h-[95vh] overflow-y-auto"}
      >
        <DialogHeader>
